...
model_configs = {
    ...
    'PointLTL0MASAR2WC-v0': zones_safety,
    'PointLTL1MASAR1WC-v0': zones_safety,
    'PointLTL1MASAR2WC-v0': zones_safety,
    'PointLTL2MASAR1WC-v0': zones_safety,
    'PointLTL2MASAR2WC-v0': zones_safety,
    'LetterEnv-v0': letter,
